return {
    ...
    },
    {
        ...
        config = function()
            ...
            -- NOTE: this might be bugged: https://github.com/nvim-treesitter/nvim-treesitter-textobjects/issues/775
            -- -- vim way: ; goes to the direction you were moving.
            vim.keymap.set({ "n", "x", "o" }, "<leader>;", ts_repeat_move.repeat_last_move, { expr = true })
            vim.keymap.set({ "n", "x", "o" }, "<leader>,", ts_repeat_move.repeat_last_move_opposite, { expr = true })
